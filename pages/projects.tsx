        ...
        <div className="flex flex-col w-full max-w-2xl px-4 mx-auto">
                ...
                <span className="text-2xl ml-2">🎹</span></h1>
            {
                projectsData.map(project => {
                    return (
                        <div key={project.name} className="grid grid-cols-3 bg-white rounded-xl max-h-30 mt-4  cursor-pointer transform transition duration-500 hover:scale-105">
                            <Image className="col-span-1 rounded-l-xl" src={spotifyImage} alt="project image ss"/>
                            <div className="py-2 px-2 col-span-2 flex flex-col justify-between">
                                <div>
