        ...
        <div>
            <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"
                ...
                <path
                    ...
                    fill="#d65813"/>
                <path d="M127.277 125.38L241.963.806a19.595 19.595 0 0 0-5.57-.807H93.515l33.763 125.38z"
                      fill="#e05e11"/>
                <path d="M19.606 256h142.622l-34.951-130.621L8.499 252.549A19.511 19.511 0 0 0 19.606 256"
                      fill="#de5c16"/>
                <path
